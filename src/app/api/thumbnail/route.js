...
const whereClause=" where  (ThumbnailBig is  NULL or ThumbnailBig='') and  MediaType='Video'  and (MediaUploadedTime > (NOW() - INTERVAL " + mediauploadedtimeinterval + " DAY))  ORDER BY MediaUploadedTime DESC"
